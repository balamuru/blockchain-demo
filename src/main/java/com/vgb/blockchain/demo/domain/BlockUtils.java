...
public class BlockUtils {
    ...
    public static <T>void mineBlock(int difficulty, Block<T> block) {
    ...
    private  static <T>String calculateBlockHash(String previousHash, long timeStamp, int nonce, T data) {
    ...
    private static byte[] dataToBytes(String dataToHash) {
        byte[] bytes;
        try {
